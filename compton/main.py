...
def fun1(angle, vec, h, index):
    ...
    ax[vec].tick_params(axis='both', labelsize=6)
    fig.text(0.5, 0.02, 'Energie [keV]', ha='center', va='center', fontproperties={'weight': 'normal', 'style': 'italic'})
...
ax.set_ylabel(r'$\frac{1}{E_2} [\frac{1}{keV}]$', fontsize=15)
